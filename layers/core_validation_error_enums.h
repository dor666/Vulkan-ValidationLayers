...
static const char DECORATE_UNUSED *kVUID_Core_DrawState_ImageSamplerIncompatibleFilter = "UNASSIGNED-CoreValidation-DrawState-ImageSamplerIncompatibleFilter";
